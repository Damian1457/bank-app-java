...
public class AccountIntegrationTest {
    ...
    @Test
    void givenAccountWithBalanceZero_whenDeposit100_thenAccountBalanceEquals60() {
        //Given
    ...
    @Test
    void givenAccountWithBalanceZero_whenDeposit0AndWithdraw10_thenAccountBalanceEquals0() {
        //Given
        Account account = new Account("11", 0.0);
    ...
    @Test
    void givenAccountWithBalanceZero_whenDeposit170AndWithdraw170_thenAccountBalanceEquals0() {
        //Given
        Account account = new Account("11", 0.0);
